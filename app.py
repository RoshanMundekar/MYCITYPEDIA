...
def dbConnection():
    connection = pymysql.connect(host="localhost", user="root", password="root", database="012-mycitypedia",charset="utf8", autocommit=True)
    return connection
...
def reject(Id):
    ...
    sql2 = "DELETE FROM review WHERE IDBUSS = %s"
    val2 = (Id,)# Notice the comma, this creates a tuple
